...
Slack 실시간 알림 예시
크롤러 실행 로그 (CRITICAL / HIGH 등 탐지)
자체 평가 및 보완점
주요 성과

End-to-End 통합 시스템 완성 (크롤링 → 탐지 → 대시보드 → 알림)
24/7 자동 모니터링 환경 구축
7명 팀원과의 성공적인 협업 경험
한계점

대용량 데이터 처리 시 메모리 사용량 증가
다크웹 사이트 구조 변경 시 수동 대응 필요
키워드 기반 탐지로 신종 위협 패턴을 놓칠 가능성
향후 개선 방향

딥러닝 기반 탐지 도입으로 정확도 향상
Email, Discord 등 다중 알림 채널 
지다중 다크웹 사이트 동시 모니터링
